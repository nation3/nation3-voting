...
/// @author Nation3 DAO
/// @notice The setup contract of the `Nation3Voting` plugin.
contract Nation3VotingSetup is PluginSetup {
    using Address for address;
    using Clones for address;
    using ERC165Checker for address;

    /// @notice The address of the `Nation3Voting` base contract.
    Nation3Voting private immutable nation3VotingBase;
    ...
    /// @notice Thrown if token address is not ERC721.
    /// @param token The token address
    ...
    function implementation() external view virtual override returns (address) {
        return address(nation3VotingBase);
    }
